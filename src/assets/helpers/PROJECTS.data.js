...
export const PROJECTS = [
    ...
    },
    {
    ...
    },
     {
        ...
        summary: "A complete graph analysis software. This software was developed using all my previously made data analytics project concepts in a more practical way. This software uses my value compression algorithm for aligning the line graph inside the frame. Also, it has an evaluation panel, where this program evaluates the given raw data according to basic statistical formulas and show that information on the panel. This software can be used as an individual product for statistical / data science research tool or as a part of other software.",
    ...
    },
    {
        ...
        summary: "An English dictionary rich with features like bookmarking, different themes, and ability to pronounce the text. It interacts with two external APIs and fetches data from those resources.",
        website: "https://jashann.github.io/Smart-Dictionary/",
        github: "https://github.com/Jashann/Smart-Dictionary/",
        tools:  "JavaScript, Browser API, LocalStorage, Design Patterns, Restful APIs",
        category: CATEGORIES.personal,
        tags:   [ CATEGORIES.personal, CATEGORIES.web ]
    },
    {
        title: "GITHUB FINDER",
        summary: "Find out any github user by entering the username and look at the important info about their profiles.",
    ...
    },
    {
        ...
        summary: "I had developed my portfolio website to be much more vibrant before. My current portfolio focuses on minimalist design so the viewer's focus remains on actual content rather than design. ",
